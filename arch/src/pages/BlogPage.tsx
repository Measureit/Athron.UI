...
import { usePaginatedBlogPosts } from '../hooks/useBlogSystem';
  ...
  return (
    <div className="fade-in">
          ...
          <Row>
            <Col lg={8} className="mx-auto text-center">
              <h1 className="text-primary mb-3">
                ...
                {`Artykuły ${APP_CONFIG.APP_NAME}`}
              </h1>
              <p className="lead text-muted">
                Odkryj zaawansowane porady treningowe, analizy taktyczne i wskazówki rozwojowe 
                dla młodych sportowców wszystkich poziomów zaawansowania.
              </p>
            </Col>
          </Row>
        </Container>
      ...
      <style>{`
        ...
        .search-input:focus {
          border-color: #0E3866;
          box-shadow: 0 0 0 0.2rem rgba(14, 56, 102, 0.25);
        }
      `}</style>
    </div>
  );
