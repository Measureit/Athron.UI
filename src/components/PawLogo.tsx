    ...
    >
      <defs>
        <radialGradient id={`mainGradient-${uniqueId}`} cx="50%" cy="30%" r="70%">
          ...
          <stop offset="70%" style={{stopColor:'#0E3866', stopOpacity:1}} />
          <stop offset="100%" style={{stopColor:'#1a4d7a', stopOpacity:1}} />
        </radialGradient>
        
        <linearGradient id={`pawGradient-${uniqueId}`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" style={{stopColor:'#F22622', stopOpacity:0.9}} />
          <stop offset="50%" style={{stopColor:'#0E3866', stopOpacity:1}} />
