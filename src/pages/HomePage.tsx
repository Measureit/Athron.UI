    ...
    <div className="fade-in">
          ...
          <Row>
            <Col lg={10} xl={8} className="mx-auto">
              ...
              <p className="lead">
                ...
                Odkryj porady treningowe, techniczne oraz motywacyjne dla młodych sportowców!
              </p>
      ...
      <section className="py-5">
        <Container>
          <Row className="text-center mb-5">
            <Col>
              <h2 className="text-primary mb-3">Dlaczego wybrać {APP_CONFIG.APP_NAME}?</h2>
              <p className="lead text-muted">
                Jesteśmy społecznością trenerów i rodziców, którzy stawiają na rozwój talentów sportowych</p>
            </Col>
          </Row>
          <Row>
            <Col md={4} className="mb-4">
              <Card className="h-100 text-center border-0 shadow-sm">
                <Card.Body className="p-4">
                  ...
                  <Card.Title className="text-primary">Artykuły Treningowe</Card.Title>
                  <Card.Text>
                    Czytaj najnowsze artykuły o technice, taktyce, przygotowaniu fizycznym 
                    i psychicznym młodych sportowców.</Card.Text>
                  <LinkContainer to="/blog">
            ...
            <Col md={4} className="mb-4">
              <Card className="h-100 text-center border-0 shadow-sm">
                <Card.Body className="p-4">
                  ...
                  <Card.Title className="text-primary">Sklep Sportowy</Card.Title>
                  <Card.Text>
                    Znajdź wszystko czego potrzebuje młody sportowiec - od odzieży sportowej, 
                    przez sprzęt treningowy, po suplementy i akcesoria.</Card.Text>
                  <LinkContainer to="/sklep">
                    <Button variant="outline-primary">
            ...
            <Col md={4} className="mb-4">
              <Card className="h-100 text-center border-0 shadow-sm">
                <Card.Body className="p-4">
                  ...
                  <Card.Text>
                    Dołącz do społeczności trenerów i rodziców. Dziel się doświadczeniami, 
                    zadawaj pytania i wspieraj innych w развojу talentów sportowych.
                  </Card.Text>
      ...
      <section className="py-5 bg-light">
        <Container>
          <Row className="mb-5">
            <Col>
              <h2 className="text-center text-primary mb-3">Najnowsze artykuły treningowe</h2>
              <p className="text-center text-muted">
                Poznaj najnowsze porady i ciekawostki ze świata sportu młodzieżowego
              </p>
            </Col>
          </Row>
      ...
      <section className="py-5">
        <Container>
          <Row className="mb-5">
            <Col>
              <h2 className="text-center text-primary mb-3">Popularne sprzęty treningowe</h2>
              <p className="text-center text-muted">
                Najchętniej wybierane przez trenerów i sportowców narzędzia treningowe
              </p>
            </Col>
          </Row>
          <Row>
