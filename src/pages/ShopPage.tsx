          ...
          <Row>
            <Col lg={8} className="mx-auto text-center">
              <h1 className="text-primary mb-3">
                ...
                {`Sklep ${APP_CONFIG.APP_NAME}`}
              </h1>
              <p className="lead text-muted">
                Wszystko czego potrzebuje młody sportowiec w jednym miejscu. 
                Wysokiej jakości sprzęt i akcesoria treningowe wybrane przez ekspertów.
              </p>
            </Col>
          </Row>
        </Container>
